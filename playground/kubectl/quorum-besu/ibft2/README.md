...
- Update the local permissions file: configmap/besu-node-permissions-configmap.yml (because this is a permissioned setup you must add enode details for every node here)
